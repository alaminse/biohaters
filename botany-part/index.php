    ...
    <section class="part_chapter_section hc_section">
        <div class="part_chapter_btn_container hc_container ep_grid">
            <div class="btn_grp_card">
                <a href="<?= $base_url ?>botany-part/" class="button w_100 no_hover">উদ্ভিদবিজ্ঞান</a>
                <a href="<?= $base_url ?>zoology-part/" class="button w_100 no_hover bg_secondary">প্রাণীবিজ্ঞান</a>
            </div>
        </div>
    </section>
