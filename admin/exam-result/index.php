    ...
    <?php if (isset($_GET['exam'])) {
        ...
        if ($num_exam > 0) {
            while ($row_exam = mysqli_fetch_assoc($sql_exam)) {
                ...
                $select_attempt = "SELECT * FROM hc_exam_attempt WHERE exam = '$exam_id' AND course = '$exam_course' AND submission_status = 'In Time' AND attempt_date <= '$exam_valid_time'";
            ...
            <div class="ep_container">
                ...
                <div class="mng_category">
                    <div class="ep_flex mb_75">
                        <h5 class="box_title">Manage Exam Result - <?php echo $exam_name; ?></h5>
                        <div class="btn_grp">
                            <a href="../update-result/?exam=<?php echo $exam_id; ?>" class="button btn_sm">Update Result</a>
                            <a href="../late-submit/?exam=<?php echo $exam_id; ?>" class="button btn_sm">Not Counted Result</a>
                        </div>
                    </div>
                        ...
                        <tbody>
                            <?php if (!empty($rank_data['student_data'])) {
                                ...
                                foreach ($rank_data['student_data'] as $key => $student_data) {
                                    ...
                                    $submit_time        = $student_data['submit_time'];
